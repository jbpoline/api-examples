...
HUMAN_BRAIN_ATLAS_ONT_ID = 7 # http://api.brain-map.org/api/v2/data/query.xml?criteria=model::Ontology,rma::criteria,[name$ilHuman%20Brain%20Atlas],
...
def DownloadAndCorrelateData():
    structureIds, structHash = DownloadStructures()
    probes = QueryAPI(PROBE_ID_QUERY_URL,10)
...
corr,structIds,structHash = DownloadAndCorrelateData()
